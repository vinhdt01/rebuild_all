...
import DescriptionProduct from "@components/description-product/description-product";
 import WarrantyProduct from "@components/warranty/warranty-product";
   import FaqProduct from "@components/faq/faq-product";

// export { getStaticPaths, getStaticProps } from "@framework/ssr/product";
export {getStaticPaths , getStaticProps}  from '@framework/ssr/translation'
