      ...
      <div className="border border-gray-300 rounded-md overflow-hidden">
        <div className="flex flex-col">
          {isEmpty ? (
            ...
            <>
              <div className="flex items-center justify-between text-heading text-base font-semibold bg-gray-200 px-[8px] py-3.5 border-b border-gray-300">
                <span>{t("text-product")}</span>
                <span>{t("text-sub-total")}</span>
              </div>
              <div className="px-[8px] py-2.5">
                {items?.map((item) => (
        ...
        <div className="px-[8px] pt-2 pb-6">
