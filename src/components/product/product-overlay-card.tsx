      ...
      >
        ...
        >
          <Image
            ...
            className="object-cover transition duration-500 ease-in-out transform group-hover:scale-110"
          />
                  <img className="absolute right-2 bottom-1 w-7 h-7" src="https://cdn.pnj.io/images/image-update/tag-product/icon-tragop-2.svg"/>
                  <img  className="absolute left-2 bottom-1 w-7 h-7" src="https://cdn.pnj.io/images/image-update/2022/10/pnjfast/PNJfast-Giaotrong3h.svg"/>
                  <img  className="absolute right-2 top-1 w-7 h-7" src="https://cdn.pnj.io/images/image-update/tag-product/new-icon-3-w29.svg"/>
